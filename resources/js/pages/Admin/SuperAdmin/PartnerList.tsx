    ...
    return (
        <AdminLayout title="Partners">
            ...
            {showDeleted && deleted.length > 0 && (
                <div className="mt-8">
                    <h3 className="mb-3 text-sm font-semibold text-gray-600">Deleted Partners</h3>
                    <div className="overflow-hidden rounded-xl border border-red-100">
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {deleted.map((p) => (
                                    <tr key={String(p.id)} className="border-t border-red-100">
                                        <td className="px-4 py-2 text-gray-700">{String(p.name ?? '-')}</td>
                                        <td className="px-4 py-2 font-mono text-gray-600">{String(p.partner_code ?? '-')}</td>
                                        <td className="px-4 py-2 text-gray-600">{String(p.contact_email ?? '-')}</td>
