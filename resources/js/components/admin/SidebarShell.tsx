        ...
        <div className="h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-[#f2fffb] to-slate-100">
            <div className="flex h-full">
                ...
                <div className="flex h-full min-w-0 flex-1 flex-col">
                    ...
                    <main className="flex-1 overflow-y-auto animate-in fade-in-0 duration-300 px-4 py-6 lg:px-8">
                        <FlashMessage />
                        <div className="rounded-2xl border border-slate-200/70 bg-white/95 p-4 shadow-[0_8px_30px_rgba(2,6,23,0.04)] lg:p-6">{children}</div>
                    </main>
