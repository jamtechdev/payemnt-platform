...
class PartnerApiGuideController extends BaseApiController
{
    #[OA\Get(
        ...
        description: 'No authentication. Returns `data` with steps, endpoint paths, `public_base_url` (from APP_URL), and Swap Circle reference notes. For a full HTML doc use GET /admin/super-admin/api-documentation.',
        tags: ['Guide'],
        responses: [
            new OA\Response(
                response: 200,
