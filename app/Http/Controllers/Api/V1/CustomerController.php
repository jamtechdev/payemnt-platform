...
class CustomerController extends BaseApiController
{
    ...
    #[OA\Put(
        ...
        summary: 'Update a partner customer by customer_code',
        security: [['sanctum' => []]],
        tags: ['Customer'],
        parameters: [
            new OA\Parameter(name: 'customer_code', in: 'path', required: true, schema: new OA\Schema(type: 'string')),
        ],
        requestBody: new OA\RequestBody(
            content: new OA\JsonContent(
                properties: [
                    ...
                    new OA\Property(property: 'valid_document', type: 'string', nullable: true),
                    new OA\Property(property: 'id_front_image', type: 'string', nullable: true),
                    new OA\Property(property: 'id_back_image', type: 'string', nullable: true),
